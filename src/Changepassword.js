    ...
    <>
      ...
      < div style={{ display: 'flex', justifyContent: 'center', alignItems: 'center', flexDirection: 'column', }}>
        ...
        <form onSubmit={handleChangePassword} style={{ alignItems: 'center' }}>
          ...
          <div style={{ position: 'relative', width: '300px', marginBottom: '10px' }}>
            <input type={showPassword ? "text" : "password"} class="form-control" style={{ width: '300px' }} placeholder="New Password" value={newPassword} onChange={e => setNewPassword(e.target.value)} />
            <span
          ...
          <div style={{ position: 'relative', width: '300px' }}>
            <input type={showPassword ? "text" : "password"} class="form-control" style={{ width: '300px' }} placeholder="Confirm Password" value={confirmPassword} onChange={e => setConfirmPassword(e.target.value)} />
            <span
